use crate::{
    domain::subscriber_email::SubscriberEmail, libs::error_chain_fmt,
    services::email::EmailService, telemetry::spawn_blocking_with_tracing,
};
use actix_web::{
    http::{
...
#[tracing::instrument(
    ...
    skip(body, pool, email_service, req),
